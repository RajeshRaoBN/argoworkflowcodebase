...
Learn about artifacts and storage.
Create a workflow that generates and consumes artifacts.
...
argo submit --serviceaccount argo-workflow --watch input-parameters-workflow.yaml
...
argo submit --serviceaccount argo-workflow --watch parameters-workflow.yaml
